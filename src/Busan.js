          ...
          <Box color="info.contrastText" p={2}>
            <motion.div whileHover={{ scale: 1.5 }} whileTap={{ scale: 0.9 }}>
              <img
                alt="face"
                src={a}
                style={{ float: "right", width: "310px", height: "200px" }}
              />
            </motion.div>
          </Box>
        </Grid>
          ...
          <Box color="info.contrastText" p={2}>
            <motion.div whileHover={{ scale: 1.9 }} whileTap={{ scale: 0.9 }}>
              <img
                alt="face"
                src={h}
                style={{ float: "left", width: "200px", height: "300px" }}
              />
            </motion.div>
          </Box>
        </Grid>
          ...
          <Box color="info.contrastText" p={2}>
            <motion.div whileHover={{ scale: 1.5 }} whileTap={{ scale: 0.9 }}>
              <img
                alt="face"
                src={e}
                style={{ float: "right", width: "300px", height: "220px" }}
              />
            </motion.div>
          </Box>
        </Grid>
          ...
          <Box color="info.contrastText" p={2}>
            <motion.div whileHover={{ scale: 2 }} whileTap={{ scale: 0.9 }}>
              <img
                alt="face"
                src={g}
                style={{ float: "right", width: "320px", height: "220px" }}
              />
            </motion.div>
          </Box>
        </Grid>
          ...
          <Box color="info.contrastText" p={2}>
            <motion.div whileHover={{ scale: 1.5 }} whileTap={{ scale: 0.9 }}>
              <img
                alt="face"
                src={d}
                style={{ float: "left", width: "300px", height: "200px" }}
              />
            </motion.div>
          </Box>
        </Grid>
          ...
          <Box color="info.contrastText" p={2}>
            <motion.div whileHover={{ scale: 1.5 }} whileTap={{ scale: 0.9 }}>
              <img
                alt="face"
                src={i}
                style={{ float: "right", width: "500px", height: "350px" }}
              />
            </motion.div>
          </Box>
        </Grid>
